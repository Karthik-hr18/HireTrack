    ...
    <section className="careers-hero">
      <div className="careers-container">
        <div className="careers-hero__grid">
          <div>
            <div className="careers-hero__badge animate-hero-badge">
              <Sparkles size={14} />
              <span>We Are Hiring · Global Remote Team</span>
            </div>

            <h1 className="careers-hero__title animate-hero-title">
              Build Products <br />
              <span style={{ color: 'var(--accent)' }}>That Matter.</span>
            </h1>

            <p className="careers-hero__subtitle animate-hero-subtitle">
            ...
            <div className="careers-hero__actions animate-hero-actions">
